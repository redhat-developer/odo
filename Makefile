...
test-app-e2e:
ifdef TIMEOUT
	go test -v github.com/redhat-developer/odo/tests/e2e --ginkgo.focus="odoAppE2e" -ginkgo.succinct -timeout $(TIMEOUT)
else
	go test -v github.com/redhat-developer/odo/tests/e2e --ginkgo.focus="odoAppE2e" -ginkgo.succinct
endif
