...
```sh
# Binary installation
sudo curl -L https://github.com/redhat-developer/odo/releases/download/v0.0.8/odo-darwin-amd64 -o /usr/local/bin/odo && sudo chmod +x /usr/local/bin/odo
...
```sh
# Binary installation
sudo curl -L https://github.com/redhat-developer/odo/releases/download/v0.0.8/odo-linux-amd64 -o /usr/local/bin/odo && sudo chmod +x /usr/local/bin/odo
