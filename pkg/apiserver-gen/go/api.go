...
type DefaultApiRouter interface {
	...
	DevstateApplyCommandCommandNameDelete(http.ResponseWriter, *http.Request)
	DevstateApplyCommandPost(http.ResponseWriter, *http.Request)
	DevstateChartGet(http.ResponseWriter, *http.Request)
	DevstateCompositeCommandCommandNameDelete(http.ResponseWriter, *http.Request)
	...
	DevstateExecCommandCommandNameDelete(http.ResponseWriter, *http.Request)
...
type DefaultApiServicer interface {
	...
	DevstateApplyCommandCommandNameDelete(context.Context, string) (ImplResponse, error)
	...
	DevstateCompositeCommandCommandNameDelete(context.Context, string) (ImplResponse, error)
	...
	DevstateExecCommandCommandNameDelete(context.Context, string) (ImplResponse, error)
