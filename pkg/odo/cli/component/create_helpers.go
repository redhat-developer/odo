...
func (co *CreateOptions) DevfileJSON() error {
	...
	cfd, err := component.NewComponentFullDescriptionFromClientAndLocalConfig(co.Client, envInfo, envInfo.GetName(), envInfo.GetApplication(), co.Project, co.ComponentContext)
	if err != nil {
		return err
	}
