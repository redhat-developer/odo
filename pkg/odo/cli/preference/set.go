...
func (o *SetOptions) Run(cmd *cobra.Command) (err error) {
	...
	if err != nil {
		return errors.Errorf("unable to set preference, something is wrong with odo, kindly raise an issue at https://github.com/openshift/odo/v2/issues/new?template=Bug.md")
	}
