...
import (
	...
	"github.com/openshift/odo/v2/pkg/odo/cli/telemetry"

	"github.com/openshift/odo/v2/pkg/odo/cli/application"
	"github.com/openshift/odo/v2/pkg/odo/cli/catalog"
	"github.com/openshift/odo/v2/pkg/odo/cli/component"
	"github.com/openshift/odo/v2/pkg/odo/cli/config"
	"github.com/openshift/odo/v2/pkg/odo/cli/debug"
	"github.com/openshift/odo/v2/pkg/odo/cli/env"
	"github.com/openshift/odo/v2/pkg/odo/cli/login"
	"github.com/openshift/odo/v2/pkg/odo/cli/logout"
	"github.com/openshift/odo/v2/pkg/odo/cli/plugins"
	"github.com/openshift/odo/v2/pkg/odo/cli/preference"
	"github.com/openshift/odo/v2/pkg/odo/cli/project"
	"github.com/openshift/odo/v2/pkg/odo/cli/registry"
	"github.com/openshift/odo/v2/pkg/odo/cli/service"
	"github.com/openshift/odo/v2/pkg/odo/cli/storage"
	"github.com/openshift/odo/v2/pkg/odo/cli/url"
	"github.com/openshift/odo/v2/pkg/odo/cli/utils"
	"github.com/openshift/odo/v2/pkg/odo/cli/version"
