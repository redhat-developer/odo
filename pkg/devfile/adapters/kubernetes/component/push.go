...
func (a *Adapter) getComponentDeployment(ctx context.Context) (*appsv1.Deployment, bool, error) {
	var (
...
func (a *Adapter) updatePVCsOwnerReferences(ctx context.Context, ownerReference metav1.OwnerReference) error {
	var (
		componentName = odocontext.GetComponentName(ctx)
	)
