...
__oc_handle_reply()
{
    ...
    if [[ ${#COMPREPLY[@]} -eq 0 ]]; then
		if declare -F __oc_custom_func >/dev/null; then
...
__oc_handle_flag()
{
    ...
    if [[ ${words[c]} != *"="* ]] && __oc_contains_word "${words[c]}" "${two_word_flags[@]}"; then
			  __oc_debug "${FUNCNAME[0]}: found a flag ${words[c]}, skip the next argument"
        c=$((c+1))
...
__oc_handle_word()
{
    ...
    if [[ "${words[c]}" == -* ]]; then
        ...
        __oc_handle_command
    elif __oc_contains_word "${words[c]}" "${command_aliases[@]}"; then
...
_oc_adm_catalog_build()
{
    last_command="oc_adm_catalog_build"
    ...
    flags+=("--appregistry-endpoint=")
    two_word_flags+=("--appregistry-endpoint")
    local_nonpersistent_flags+=("--appregistry-endpoint=")
    flags+=("--appregistry-org=")
    two_word_flags+=("--appregistry-org")
    local_nonpersistent_flags+=("--appregistry-org=")
    flags+=("--auth-token=")
    ...
    local_nonpersistent_flags+=("--skip-verification")
    flags+=("--to=")
    two_word_flags+=("--to")
    local_nonpersistent_flags+=("--to=")
    flags+=("--to-db=")
    two_word_flags+=("--to-db")
    local_nonpersistent_flags+=("--to-db=")
    flags+=("--as=")
    two_word_flags+=("--as")
    flags+=("--as-group=")
    two_word_flags+=("--as-group")
...
_oc_adm_catalog_mirror()
{
    last_command="oc_adm_catalog_mirror"
    ...
    local_nonpersistent_flags+=("--skip-verification")
    flags+=("--to-manifests=")
    two_word_flags+=("--to-manifests")
    local_nonpersistent_flags+=("--to-manifests=")
    flags+=("--as=")
    two_word_flags+=("--as")
    flags+=("--as-group=")
    two_word_flags+=("--as-group")
...
_oc_adm_must-gather()
{
    last_command="oc_adm_must-gather"
...
_oc_adm_node-logs()
{
    ...
    flags+=("--unify")
    local_nonpersistent_flags+=("--unify")
    flags+=("--unit=")
    two_word_flags+=("--unit")
    two_word_flags+=("-u")
    local_nonpersistent_flags+=("--unit=")
    flags+=("--until=")
...
_oc_adm_policy_add-cluster-role-to-group()
{
    ...
    two_word_flags+=("--rolebinding-name")
...
_oc_adm_prune_images()
{
    ...
    two_word_flags+=("--keep-tag-revisions")
...
_oc_adm_release_extract()
{
    ...
    flags+=("--command-os=")
    two_word_flags+=("--command-os")
    local_nonpersistent_flags+=("--command-os=")
    flags+=("--dir=")
    two_word_flags+=("--dir")
    local_nonpersistent_flags+=("--dir=")
    flags+=("--file=")
    ...
    local_nonpersistent_flags+=("--to=")
    flags+=("--tools")
    local_nonpersistent_flags+=("--tools")
    flags+=("--as=")
    two_word_flags+=("--as")
    flags+=("--as-group=")
    two_word_flags+=("--as-group")
...
_oc_adm_release_mirror()
{
    ...
    local_nonpersistent_flags+=("--to=")
    flags+=("--to-dir=")
    two_word_flags+=("--to-dir")
    local_nonpersistent_flags+=("--to-dir=")
    flags+=("--to-image-stream=")
    two_word_flags+=("--to-image-stream")
    local_nonpersistent_flags+=("--to-image-stream=")
    flags+=("--to-mirror")
    local_nonpersistent_flags+=("--to-mirror")
    flags+=("--to-release-image=")
    two_word_flags+=("--to-release-image")
    local_nonpersistent_flags+=("--to-release-image=")
    flags+=("--as=")
    two_word_flags+=("--as")
    flags+=("--as-group=")
    two_word_flags+=("--as-group")
...
_oc_adm_release_new()
{
    ...
    two_word_flags+=("--component-versions")
    local_nonpersistent_flags+=("--component-versions=")
    flags+=("--component-versions-display-names=")
    two_word_flags+=("--component-versions-display-names")
    local_nonpersistent_flags+=("--component-versions-display-names=")
    flags+=("--dir=")
    two_word_flags+=("--dir")
    local_nonpersistent_flags+=("--dir=")
    flags+=("--dry-run")
    ...
    two_word_flags+=("--from-image-stream")
    local_nonpersistent_flags+=("--from-image-stream=")
    flags+=("--from-image-stream-file=")
    two_word_flags+=("--from-image-stream-file")
    two_word_flags+=("-f")
    local_nonpersistent_flags+=("--from-image-stream-file=")
    flags+=("--from-release=")
    ...
    local_nonpersistent_flags+=("--output=")
    flags+=("--previous=")
    two_word_flags+=("--previous")
    local_nonpersistent_flags+=("--previous=")
    flags+=("--reference-mode=")
    two_word_flags+=("--reference-mode")
    local_nonpersistent_flags+=("--reference-mode=")
    flags+=("--registry-config=")
    two_word_flags+=("--registry-config")
    two_word_flags+=("-a")
    local_nonpersistent_flags+=("--registry-config=")
    flags+=("--release-manifest")
    local_nonpersistent_flags+=("--release-manifest")
    flags+=("--skip-manifest-check")
    local_nonpersistent_flags+=("--skip-manifest-check")
    flags+=("--skip-verification")
    local_nonpersistent_flags+=("--skip-verification")
    flags+=("--to-dir=")
    two_word_flags+=("--to-dir")
    ...
    flags+=("--to-image=")
    two_word_flags+=("--to-image")
    local_nonpersistent_flags+=("--to-image=")
    flags+=("--to-image-base=")
    two_word_flags+=("--to-image-base")
    local_nonpersistent_flags+=("--to-image-base=")
    flags+=("--to-image-base-tag=")
    two_word_flags+=("--to-image-base-tag")
    local_nonpersistent_flags+=("--to-image-base-tag=")
    flags+=("--to-signature=")
    two_word_flags+=("--to-signature")
    local_nonpersistent_flags+=("--to-signature=")
    flags+=("--as=")
    two_word_flags+=("--as")
    flags+=("--as-group=")
    two_word_flags+=("--as-group")
...
_oc_adm_upgrade()
{
    ...
    local_nonpersistent_flags+=("--to-image=")
    flags+=("--to-latest")
    local_nonpersistent_flags+=("--to-latest")
    flags+=("--as=")
    two_word_flags+=("--as")
    flags+=("--as-group=")
    two_word_flags+=("--as-group")
...
_oc_adm_verify-image-signature()
{
    ...
    two_word_flags+=("--expected-identity")
...
_oc_cluster-info_dump()
{
    last_command="oc_cluster-info_dump"
...
_oc_create_clusterresourcequota()
{
    ...
    two_word_flags+=("--project-annotation-selector")
...
_oc_create_cronjob()
{
    last_command="oc_create_cronjob"
...
_oc_create_route_edge()
{
    ...
    two_word_flags+=("--insecure-policy")
...
_oc_create()
{
    ...
    if [[ -z "${BASH_VERSION}" || "${BASH_VERSINFO[0]}" -gt 3 ]]; then
        command_aliases+=("clusterquota")
        aliashash["clusterquota"]="clusterresourcequota"
    fi
    ...
    if [[ -z "${BASH_VERSION}" || "${BASH_VERSINFO[0]}" -gt 3 ]]; then
        command_aliases+=("dc")
        aliashash["dc"]="deploymentconfig"
    fi
    commands+=("identity")
    commands+=("imagestream")
    if [[ -z "${BASH_VERSION}" || "${BASH_VERSINFO[0]}" -gt 3 ]]; then
        command_aliases+=("is")
        aliashash["is"]="imagestream"
    fi
    commands+=("imagestreamtag")
    if [[ -z "${BASH_VERSION}" || "${BASH_VERSINFO[0]}" -gt 3 ]]; then
        command_aliases+=("istag")
        aliashash["istag"]="imagestreamtag"
    fi
    commands+=("job")
    commands+=("namespace")
    if [[ -z "${BASH_VERSION}" || "${BASH_VERSINFO[0]}" -gt 3 ]]; then
...
_oc_idle()
{
    ...
    two_word_flags+=("--resource-names-file")
...
_oc_image_extract()
{
    ...
    two_word_flags+=("--path")
    local_nonpersistent_flags+=("--path=")
    flags+=("--preserve-ownership")
    flags+=("-p")
    local_nonpersistent_flags+=("--preserve-ownership")
    flags+=("--registry-config=")
    two_word_flags+=("--registry-config")
    two_word_flags+=("-a")
    local_nonpersistent_flags+=("--registry-config=")
...
_oc_image_mirror()
{
    ...
    two_word_flags+=("--s3-source-bucket")
    local_nonpersistent_flags+=("--s3-source-bucket=")
    flags+=("--skip-missing")
    local_nonpersistent_flags+=("--skip-missing")
    flags+=("--skip-mount")
...
_oc_image_serve()
{
    ...
    flags+=("--tls-crt=")
    two_word_flags+=("--tls-crt")
    local_nonpersistent_flags+=("--tls-crt=")
    flags+=("--tls-key=")
...
_oc_new-build()
{
    ...
    two_word_flags+=("--build-config-map")
    local_nonpersistent_flags+=("--build-config-map=")
    flags+=("--build-secret=")
    two_word_flags+=("--build-secret")
...
_oc_registry_login()
{
    ...
    flags+=("--auth-basic=")
    two_word_flags+=("--auth-basic")
    local_nonpersistent_flags+=("--auth-basic=")
    flags+=("--insecure")
    local_nonpersistent_flags+=("--insecure")
    flags+=("--registry=")
...
_oc_rollout_restart()
{
    last_command="oc_rollout_restart"
...
_oc_set_probe()
{
    ...
    two_word_flags+=("--success-threshold")
...
_oc_set_serviceaccount()
{
    last_command="oc_set_serviceaccount"
...
_oc_set()
{
    ...
    commands+=("volumes")
    if [[ -z "${BASH_VERSION}" || "${BASH_VERSINFO[0]}" -gt 3 ]]; then
        command_aliases+=("volume")
        aliashash["volume"]="volumes"
    fi
...
_oc_start-build()
{
    ...
    local_nonpersistent_flags+=("--follow")
    flags+=("--from-archive=")
    two_word_flags+=("--from-archive")
    local_nonpersistent_flags+=("--from-archive=")
    flags+=("--from-build=")
    two_word_flags+=("--from-build")
...
_oc_root_command()
{
    ...
    if [[ -z "${BASH_VERSION}" || "${BASH_VERSINFO[0]}" -gt 3 ]]; then
        ...
        aliashash["secret"]="secrets"
    fi
    commands+=("serviceaccounts")
    if [[ -z "${BASH_VERSION}" || "${BASH_VERSINFO[0]}" -gt 3 ]]; then
        command_aliases+=("sa")
        aliashash["sa"]="serviceaccounts"
    fi
    commands+=("set")
