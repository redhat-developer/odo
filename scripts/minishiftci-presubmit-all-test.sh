...
export JOB_NAME="odo-pr-minishift-tests"
...
./ci-firewall request --sendqueue amqp.ci.queue.minishift.send --sendtopic amqp.ci.topic.minishift.send --runscript scripts/minishift-all-test.sh  --timeout 4h00m
