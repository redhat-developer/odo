...
# Login as developer	##### These are variables used by ci-firewall as one of the ways to get its parameters
odo login -u developer -p password@123	# If AMQP_URI is not set by the time we reach here, show error message and exit.
