...
oc apply -n openshift -f https://raw.githubusercontent.com/openshift/library/master/arch/s390x/official/java/imagestreams/redhat-openjdk18-openshift-rhel-s390x.json
sleep 5
