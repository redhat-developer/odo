...
----
   ...
   Devfile Object Validation
    ✓  Checking devfile existence [109745ns]
    ✓  Creating a devfile component from registry: DefaultDevfileRegistry [131586ns]
   Validation
    ✓  Validating if devfile name is correct [106545ns]
