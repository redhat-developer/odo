...
Openshift 3.11 tests service catalog which is not tested in openshift 4.x version. 
...
image::https://github.com/anandrkskd/odo/blob/workflow-for-ci/docs/img/CI-reference-workflow.png[CI-workflow]
