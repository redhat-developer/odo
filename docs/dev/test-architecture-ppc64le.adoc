...
Odo CI for ppc64le is running locally now.The scripts/configure-installer-tests-cluster-ppc64le.sh is available in the https://github.com/openshift/odo/tree/master/scripts[odo] repository to help configure the test environment and the scripts/openshiftci-presubmit-all-tests.sh is available in the https://github.com/openshift/odo/tree/master/scripts[odo] repository to run integration and e2e tests covered on ppc64le arch.  
