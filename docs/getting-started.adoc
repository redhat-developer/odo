...
. This creates the URL and adds an entry in the local configuration file:
+
----
$ odo url create --port 8080
----
+
. Push the changes which will create a URL on cluster:
+
----
$ odo push
----
+
. List the URLs to check the desired URL for component.
+
----
$ odo url list
----
