...
The changes from v2 to v3 have been huge, but that does not have to mean big changes for you. We have articulated the migration process in this [migration doc](/docs/user-guides/v3-migration-guide) to ease things for you.
