...
Thanks to the emergence of the [devfile](https://devfile.io/) open standard, which  has been accepted as a CNCF Sandbox project recently (in January 2022), odo v3 is now entirely based on this open standard.
