...
var _ = Describe("odo storage command tests", func() {
	...
	Context("when using storage command with -o json", func() {
		It("should create and list output in json format", func() {
			...
			desiredJSONStorage := `{"kind":"storage","apiVersion":"odo.openshift.io/v1","metadata":{"name":"mystorage","creationTimestamp":null},"spec":{"size":"1Gi","path":"/opt/app-root/src/storage/"}}`
			...
			desiredStorageList := `{"kind":"List","apiVersion":"odo.openshift.io/v1","metadata":{},"items":[{"kind":"storage","apiVersion":"odo.openshift.io/v1","metadata":{"name":"mystorage","creationTimestamp":null},"spec":{"size":"1Gi","path":"/opt/app-root/src/storage/"},"status":"Not Pushed"}]}`
