...
var _ = Describe("odo generic", func() {
	...
	It("returns JSON error when using an invalid command with JSON output", func() {
	...
	It("returns JSON error when using an invalid sub-command with JSON output", func() {
