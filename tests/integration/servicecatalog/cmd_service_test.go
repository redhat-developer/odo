...
var _ = Describe("odo service command tests", func() {
	...
	Context("when running help for service command", func() {
		It("should pass oc command in centos nodejs", func() {
			helper.CmdShouldPass("oc", "new-project", "nodejs")
			helper.CmdShouldPass("oc", "new-app", "centos/nodejs-8-centos7~https://github.com/sclorg/nodejs-ex", "--namespace", "nodejs")
		})

		It("should pass oc command in rhel nodejs", func() {
			helper.CmdShouldPass("oc", "new-project", "nodejsx")
			oc.ImportImageFromRegistry("registry.access.redhat.com", filepath.Join("rhscl", "nodejs-8-rhel7:latest"), "nodejs:latest", "nodejsx")
			helper.CmdShouldPass("oc", "new-app", "registry.access.redhat.com/rhscl/nodejs-8-rhel7~https://github.com/sclorg/nodejs-ex", "--namespace", "nodejsx")
		})
