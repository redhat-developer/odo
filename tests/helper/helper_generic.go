...
func UniqueRandString(n int) string {
	...
	b := make([]byte, n)
	for i := range b {
		b[i] = letterBytes[helperRand.Intn(len(letterBytes))]
	}
...
var helperRand *rand.Rand

// initSharedRand initializes the 'helperRand' rand object using a seed generated by crypto.rand.
//
