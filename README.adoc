...
On top of sprint planning calls, we have regular "odo contributors call" (on Tuesdays every two weeks). This is where we discuss technical challenges and anything related to odo development.
...
To participate in calls, please join link:https://groups.google.com/forum/\#!forum/odo-dev[odo-dev Google group]. When you join the group, you will automatically get invites to all odo related calls and get permissions to all necessary documents.
