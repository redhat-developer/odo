...
==== OS-independent automated installation for Mac and *nix systems
...
For more installation options please refer the link:docs/installation.adoc[installation document].
