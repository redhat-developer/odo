...
|====
|Node.js|Java
|`centos/nodejs-10-centos7`|`redhat-openjdk-18/openjdk18-openshift`
|`centos/nodejs-12-centos7`|`openjdk/openjdk-11-rhel8`
|`bucharestgold/centos7-s2i-nodejs`| `openjdk/openjdk-11-rhel7`
