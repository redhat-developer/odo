...
https://coreos.slack.com/messages/CHS495NE9[image:https://img.shields.io/badge/Slack-Join%20Chat-yellowgreen?style=for-the-badge&logo=slack[Slack]]
...
*Chat*: Join us in our link:https://coreos.slack.com/messages/CHS495NE9[Slack] channel
