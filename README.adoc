...
* Lists all the available components and services from the OpenShift cluster.

=== Supported languages and corresponding container images
Run `odo catalog list components` to list the supported languages and corresponding container images present on your cluster.
...
. Log in to the OpenShift cluster with `odo`:
+
----
$ odo login -u developer -p developer
----

. List the languages and corresponding container images available for your cluster with `odo catalog list components`.
+
----------------------------------------------------
...
----------------------------------------------------
+
The command lists the components and the languages in two sections - supported and unsupported by Red Hat. `TAGS` column represents the image version, for example `10` represents `rhoar-nodejs/nodejs-10`.
