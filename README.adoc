...
=== Contributing
Want to become a contributor and submit your own code?
Have a look at our link:https://github.com/openshift/odo/blob/master/docs/dev/development.adoc[Development Guide].

We work in 3 week cycles sprints. On a week when sprint starts we have 2 planning calls:

* "Sprint Planning Preparation and Issue Triage" - on Monday
* "Sprint Planning" - on Wednesday

On top of sprint planning calls we have regular "odo contributors call" (on Tuesdays every 2 weeks). This is where we discuss technical challenges and anything that is related to odo development.

All our calls are open. You are welcome to join any of our calls.

You can find exact dates of all scheduled odo calls together with sprint dates in link:https://calendar.google.com/calendar/embed?src=gi0s0v5ukfqkjpnn26p6va3jfc%40group.calendar.google.com[odo calendar] (link:https://calendar.google.com/calendar/ical/gi0s0v5ukfqkjpnn26p6va3jfc%40group.calendar.google.com/public/basic.ics[iCal format]).

In order to participate in calls, please join  link:https://groups.google.com/forum/\#!forum/odo-dev[odo-dev Google group]. When you join the group you should automatically get invites to all odo related calls and get permissions to all necessary documents.
